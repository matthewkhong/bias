...
loadJSON(function(json) {
    ...
    .add(function (sender, options) {
        ...
        switch (questionName){
            ...
            case "inputModality":
                ...
                $('.q7').hide(500);
                $('.q8').hide(500);
                $("#q1taskn").addClass("blue");
                $("#q1taskn").removeClass("grey");
                break;
            case "trigger":
                ...
                $('.q7').hide(500);
                $('.q8').hide(500);
                $(".q2taskn").addClass("blue");
                $(".q2taskn").removeClass("grey");
                break;  
            case "delimiter":
                ...
                $('.q7').hide(500);
                $('.q8').hide(500);
                $(".q3taskn").addClass("blue");
                $(".q3taskn").removeClass("grey");
                break;
            case "interpretation":
                ...
                $('.q7').hide(500);
                $('.q8').hide(500);
                $(".q4taskn").addClass("blue");
                $(".q4taskn").removeClass("grey");
                break;
            case "responseType":
                var collapsed = $("#expandFive").hasClass('collapsed');
                if (collapsed == true) {
                ...
                $('.q7').hide(500);
                $('.q8').hide(500);
                $(".q5taskn").addClass("blue");
                $(".q5taskn").removeClass("grey");
                break;
            case "responseMechanism":
                ...
                $('.q7').show(500);
                $('.q8').hide(500);
                $(".q6taskn").addClass("blue");
                $(".q6taskn").removeClass("grey");
                break;
            case "responseClassification":
                ...
                $('.q7').hide(500);
                $('.q8').show(500);
                $(".q7taskn").addClass("blue");
                $(".q7taskn").removeClass("grey");
                break;
            default:
        }
  ...
  survey.onComplete.add(function (s) {
    ...
    $(".q8taskn").addClass("blue");
    $(".q8taskn").removeClass("grey");
